...
public class GameLogic {
	...
	public void placeBet(int amount) {
		...
		player.placeBet(amount); updateUserChips();
	...
	private void handleInitialPlayerBlackjack() {
		...
		updateUserChips(); saveUserData(); currentState = GameState.ROUND_OVER;
	}
	...
	private void handlePlayerBust() {
		...
		updateUserChips(); saveUserData(); gameMessage = "Player Busts! You lose.";
		currentState = GameState.ROUND_OVER; dealerCardHidden = false;
	}
	...
	// --- Utility Methods ---
	private void updateUserChips() { if(player != null && currentUser != null) currentUser.setChips(player.getChips()); }
	private void saveUserData() { if (currentUser == null) return; if (Main.useStubDatabase) { StubDatabase.updateUser(currentUser); } else { UserService.updateUser(currentUser); } }
